...
| `alloy.image` | `paulmw/alloy:v1.17.1-rp-0.2.0-dev-clustering` | Alloy container image. Must be built from this fork (or a later release of it) — a stock/upstream Alloy image won't have the custom components this chart depends on |
